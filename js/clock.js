$(document).ready(function(){
	...
	var FONT_HEIGHT=15,MARGIN=35,HAND_TRUNCATION=canvas.width/25,
	...
	function drawCircle()
	{
		context.beginPath();//开始定义路径
		context.arc(canvas.width/2,canvas.height/2,RADIUS,0,Math.PI*2,true);//创建一个圆形的路径
		context.stroke();//使路径可见
	}
